...
{Chicken Fricass\'{e}e}
  ...
  \preparation{
    ...
    \step Bring the mixture to a boil, then add the chicken and any accumulated juices to the skillet.
    ...
    \step Whisking constantly, slowly stir \unit[\nicefrac{1}{2}]{cups} of the souce from the skillet into
          the sour cream mixture to temper.
