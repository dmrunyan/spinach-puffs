...
{Guacamole}
  ...
  \preparation{%
    \step Dice tomatoes into small pieces, then drain the excess juice using strainer
          or a paper towel. Mix with cilantro in a bowl and set aside.
    ...
    \step Seed and scoop the avocados into a mixing bowl, tossing them in a small amount
          of lime juice as you go to avoid browning.
    ...
    \step Puch the guacamole into the bottom of the bowl to expose as little surface area
